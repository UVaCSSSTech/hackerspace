...
class PresidentialTeam extends Component{
  ...
  render(){
    const presidential_board = [
      {
        ...
        img : "/assets/images/team/jiakaizhang.jpg"
      },
    ]
    ...
    return(
      <div>
      <Container>
        <Image src= "/assets/images/team/presidential_board.jpg"/>
      </Container>
...
class PublicityTeam extends Component{
  ...
  render(){
    ...
    return(
      <div>
        <Container>
          <Image src= "/assets/images/team/publiciry.jepg"/>
        </Container>
...
class ActivityTeam extends Component{
  ...
  render(){
    ...
    return(
      <div>
        <Container>
          <Image src= "/assets/images/team/activity.jpeg"/>
        </Container>
...
class OutreachTeam extends Component{
  ...
  render(){
    ...
    return(
      <div>
        <Container>
          <Image src= "/assets/images/team/outreach.jpeg"/>
        </Container>
...
class CareerTeam extends Component{
  ...
  render(){
    ...
    return(
      <div>
        <Container>
          <Image src= "/assets/images/team/career.jpeg"/>
        </Container>
        {this.careerProfile}
      </div>
    );
...
class CultureTeam extends Component{
  ...
  render(){
    ...
    return(
      <div>
        <Container>
          <Image src= "/assets/images/team/culture.jpeg"/>
        </Container>
        {this.cultureProfile}
      </div>
    );
      ...
      <Container>
        <Router>
          ...
          <Switch>
            ...
            <Route exact path='/team/career' component={CareerTeam}></Route>
          </Switch>
        </Router>
      </Container>
  );
